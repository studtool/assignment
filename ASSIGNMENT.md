...
Для реализации клиентской части одностраничного приложения используется схема "модель - вид - контроллер" (MVC). Данное разделение позволяет проектировать приложение в соответствии с принципом единственной ответственности (SRP), а также разделить обязанности по реализации интерфейса и логики приложения между различными командами разработчиков.

## Требования к интерфейсу

Пользовательский интерфейс должен обладать следующими характеристиками:
1. адаптивность - способность подстраиваться под размер экрана устройства пользователя;
2. кроссбраузерность - способность работать в любом браузере нескольких последних версий;
3. расширяемость - возможность легко расширять и модифицировать пользовательский интерфейс;
4. доступность в три клика - любая страница приложения доступна максимум в три клика с главной страницы;
5. интуитивно понятный интерфейс - используются стандартные элементы управления;
6. быстрый отклик - используются специальные техники для ускорения работы страниц портала, такие как сжатие динамически загружаемого контента.
